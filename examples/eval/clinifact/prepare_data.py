...
def datareader(
    ...
    train_path = os.path.join(originalFilePath, f"train_set.csv")
    ...
    dev_path = os.path.join(originalFilePath, f"validation_set.csv")
    ...
    test_path = os.path.join(originalFilePath, f"test_set.csv")
...
def main(args):
    ...
    train_data, dev_data, test_data = datareader(originalFilePath=args[0], version=VERSION)
